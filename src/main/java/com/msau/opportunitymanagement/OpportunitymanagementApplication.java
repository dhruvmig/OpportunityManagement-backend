package com.msau.opportunitymanagement;

import com.msau.opportunitymanagement.DAO.OpportunityDao;
...
public class OpportunitymanagementApplication {
	...
	private static OpportunityDao dao;

	public OpportunitymanagementApplication(OpportunityDao dao){
		this.dao = dao;
	}
